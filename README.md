...
**Project**: html-dialogue-genie 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Can you create this?

I want edits to prompt openAI with system prompt that explains it should take the user prompt and return html in an <html></html> tag to produce it, which is parsed and overwrites the iframe

I want chat to be a dialog about

Let me enter the api key in an input field that's backed by localstorage

visual edit and page selector are buttons that don't do anything at first
...
```sh
git clone https://github.com/GPT-Engineer-App/html-dialogue-genie.git
cd html-dialogue-genie
npm i
